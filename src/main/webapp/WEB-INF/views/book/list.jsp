...
<body>
	<h1>책 목록</h1>
	<p>
	<!-- action 속성 생략시, 현재URL(/list)를 재요청 method는 GET(form 태그의 기본 method는 get) -->
	<!-- http://localhost/list?keyword=java -->
		<form>
	...
	<table border="1">
		...
		<!-- forEach 태그
			...
			Map(HashMap, HashTable,SortedMap)에 저장되어 있는 값들을 
			순차적으로 처리할때 사용함. 자바의 for,do~while을 대신해서 사용함
		 	var : 변수
